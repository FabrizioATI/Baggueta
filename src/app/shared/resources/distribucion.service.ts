...
export class DistribucionService {
    ...
    constructor(
        ...
        this.urlApi = this.appConfig.getUrlApiByModule(Module.Administrador) + "producciondistribucion/";
    }
    ...
    public buscar(): Observable<any> {
        ...
        return this.httpClient.post<any>(this.urlApi + "listaProductosDistribucionTodos", objetoJSON)
            .pipe(
                map(respuestaAPI => { return respuestaAPI }),
                catchError(new ErrorInfo().parseObservableResponseError)
            );
