...
export class ErrorInfo {
    ...
    public parseObservableResponseError(response: any): Observable<any> {
    ...
    private decodeErrorArrayBuffer = (errorInArrayBuffer: ArrayBuffer) => {
        const decoder = new TextDecoder("utf-8");
        const decodedString = decoder.decode(new Uint8Array(errorInArrayBuffer));
